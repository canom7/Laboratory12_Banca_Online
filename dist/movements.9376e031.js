...
},{"./lib/axios":"../node_modules/axios/lib/axios.js"}],"common/api/api.js":[function(require,module,exports) {
"use strict";
...
},{"./element.helpers":"common/helpers/element.helpers.js"}],"pages/movements/movements.mappers.js":[function(require,module,exports) {
"use strict";
...
var getMovementsList = function getMovementsList(accountId) {
...
var _api = require("../../common/api/api");
...
var giveMeDetailsAccount = Boolean(params.id);

// Movements
(0, _movements2.getMovementsList)().then(function (movementList) {
  var viewModelMovements = (0, _movements.mapMovementsApiToVm)(movementList, params.id);
  if (params.id === undefined) (0, _movements3.addMovementRows)(movementList);else {
    var movementsAccount = function movementsAccount(movementsVM) {
      return movementsVM.filter(function (movements) {
        return movements !== undefined;
      });
    }; // descartamos los huecos vacios del array
    (0, _movements3.addMovementRows)(movementsAccount(viewModelMovements)); // los imprimimos por pantalla
  }
});

// Account details
if (giveMeDetailsAccount) {
  (0, _api.getAccount)(params.id).then(function (apiAccount) {
    account = (0, _account.mapAccountFromApiToViewModel)(apiAccount);
    (0, _helpers.onSetValues)(account);
  });
}
},{"../../core/router":"core/router/index.js","../../common/api/api":"common/api/api.js","../account/account.mappers":"pages/account/account.mappers.js","../../common/helpers":"common/helpers/index.js","./movements.mappers":"pages/movements/movements.mappers.js","./movements.api":"pages/movements/movements.api.js","./movements.helpers":"pages/movements/movements.helpers.js"}],"../node_modules/parcel/src/builtins/hmr-runtime.js":[function(require,module,exports) {
