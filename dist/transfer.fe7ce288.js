...
},{"@lemoncode/fonk":"../node_modules/@lemoncode/fonk/dist/@lemoncode/fonk.esm.js"}],"pages/transfer/custom.validations.js":[function(require,module,exports) {
"use strict";
...
var yearValidator = function yearValidator(_ref3) {
  ...
  var succeeded = parseInt(value) >= 2023;
  return {
    succeeded: succeeded,
    message: succeeded ? '' : 'Valor del campo "Año" debe ser mayor al año actual (2023)',
    type: ''
  };
};
...
var _custom = require("./custom.validations");
var validationSchema = {
  field: {
    ...
    day: [{
      ...
      validator: _custom.dayValidator
    }],
    month: [{
      validator: _fonk.Validators.required,
      message: 'Campo requerido'
    }, {
      validator: _custom.monthValidator
    }],
    year: [{
      validator: _fonk.Validators.required,
      message: 'Campo requerido'
    }, {
      validator: _custom.yearValidator
    }],
    email: [{
...
exports.formValidation = formValidation;
},{"@lemoncode/fonk":"../node_modules/@lemoncode/fonk/dist/@lemoncode/fonk.esm.js","@lemoncode/fonk-iban-validator":"../node_modules/@lemoncode/fonk-iban-validator/dist/@lemoncode/fonk-iban-validator.esm.js","@lemoncode/fonk-positive-number-validator":"../node_modules/@lemoncode/fonk-positive-number-validator/dist/@lemoncode/fonk-positive-number-validator.esm.js","./custom.validations":"pages/transfer/custom.validations.js"}],"core/router/routes.js":[function(require,module,exports) {
"use strict";
...
(0, _helpers.onSubmitForm)('transfer-button', function () {
  _transfer.formValidation.validateForm(transfer).then(function (result) {
    ...
    if (result.succeeded) {
      (0, _transfer3.insertTransfer)(transfer).then(function () {
        _router.history.push(_router.routes.accountList);
      });
    }
  });
});
},{"../../common/helpers":"common/helpers/index.js","./transfer.validations":"pages/transfer/transfer.validations.js","../../core/router":"core/router/index.js","../account-list/account-list.api":"pages/account-list/account-list.api.js","./transfer.helpers":"pages/transfer/transfer.helpers.js","./transfer.api":"pages/transfer/transfer.api.js"}],"../node_modules/parcel/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
